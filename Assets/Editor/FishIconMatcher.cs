    ...
    public class FishIconMatcher : EditorWindow
    {
        ...
        private static string GetMappedName(string id)
        {
            var mapping = new Dictionary<string, string>
            {
                ...
                { "fish_krill", "fish42" }, { "fish_lionfish", "ocean_fish3" }, { "fish_lobster", "deep_sea_fish1" },
                { "fish_manowar", "ocean_fish1" }, { "fish_mantaray", "ocean_fish3" }, { "fish_manta_ray", "ocean_fish3" },
                { "fish_marlin", "ocean_fish2" }, { "fish_octopus", "deep_sea_fish3" }, { "fish_oyster", "deep_sea_fish1" },
                { "fish_sawfish", "deep_sea_fish2" }, { "fish_seahorse", "ocean_fish1" }, { "fish_seaturtle", "deep_sea_fish1" },
                { "fish_sea_turtle", "deep_sea_fish1" }, { "fish_shark_greatwhite", "deep_sea_fish2" },
                { "fish_shark_hammerhead", "deep_sea_fish2" }, { "fish_shrimp", "deep_sea_fish3" }, { "fish_squid", "deep_sea_fish3" },
                { "fish_stingray", "ocean_fish2" }, { "fish_sunfish", "ocean_fish2" }, { "fish_swordfish", "ocean_fish2" },
                { "fish_tuna", "ocean_fish1" }, { "fish_whale", "ocean_fish1" },
